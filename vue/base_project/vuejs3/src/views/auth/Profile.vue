  ...
  <div>
    ...
    <div class="my-10">
      <v-form ref="form" @submit.prevent="update()">
        ...
        <v-row align="center">
          <v-col cols="12" sm="3" class="pl-10"> ชื่อ </v-col>
          <v-col cols="10" sm="7">
            <v-text-field
        ...
        <v-row align="center">
          <v-col cols="12" sm="3" class="pl-10"> นามสกุล </v-col>
          <v-col cols="10" sm="7">
            <v-text-field
        ...
        <v-row align="center">
          <v-col cols="12" sm="3" class="pl-10"> อีเมล (สำหรับ Login) </v-col>
          <v-col cols="10" sm="7">
            <v-text-field
        ...
        <v-row align="center">
          <v-col cols="12" sm="3" class="pl-10"> เบอร์โทรศัพท์ </v-col>
          <v-col cols="10" sm="7">
            <v-text-field
              v-model="profile.tel"
              color="app-theme"
        ...
        <v-row align="center">
          <v-col cols="12" sm="3" class="pl-10"> ตำแหน่ง </v-col>
          <v-col cols="10" sm="7">
            <v-select
        ...
        <v-row align="center">
          <v-col cols="12" sm="3" class="pl-10"> Username </v-col>
          <v-col cols="10" sm="7">
            <v-text-field

                    ...
                    <div className="col align-self-center">
                        <div className="gray-bg ibox-content loginscreen animated fadeInDown">
                            <div>
                                ...
                                <p className="text-center">Create account to see it in action.</p>
                                <form className="m-t" id="form" onSubmit={this.handleSubmit}>
                                    <div className="form-group">
                                        <label>FirstName</label>
                                        <input type="text" className="form-control" placeholder="FirstName" required name="first_name" />
                                    </div>
                                    <div className="form-group">
                                        <label>LastName</label>
                                        <input type="text" className="form-control" placeholder="LastName" required name="last_name" />
                                    </div>
                                    <div className="form-group">
                                        <label>Email</label>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="password" className="form-control" placeholder="Confirm Password" required name="confirm_password" />
                                    </div>
                                    <div className="form-group text-center" >
                                        <div className="checkbox i-checks">
                                            <label> <input type="checkbox" name="confirm"></input><i></i> Agree the terms and policy </label></div>
                                    </div>
                                    <button type="submit" className="btn btn-primary block full-width m-b">Register</button>

                                    <p className="text-muted text-center"><small>Already have an account?</small></p>
                                    <Link to="/login" className="btn btn-sm btn-white btn-block">Go to login</Link>
                                </form>
                            </div>
                        </div>
                    </div>
